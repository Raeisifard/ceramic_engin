...
//    }
    ...
    public static String purePDateStr(String inDate) {
        ...
        if (inDate.length() == 6)  //yyyymmdd
            if (inDate.substring(0, 2).trim().length() == 2 && Integer.parseInt(inDate.substring(0, 2)) >= 90)
                inDate = "13" + inDate;
            else
                inDate = "14" + inDate;
        return inDate;
...
//        else
    ...
    public static java.util.List<String> commonItemsStringArrayList(java.util.List<String> one, java.util.List<String> two) {
        //return common items
    ...
    public static java.util.List<String> moreItemsStringArrayList(java.util.List<String> one, java.util.List<String> two) {
