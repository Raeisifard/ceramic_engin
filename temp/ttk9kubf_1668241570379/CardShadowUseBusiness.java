...
import static com.vx6.utils.Library.*;

public class CardShadowUseBusiness extends MasterVerticle {
    ...
    public void process(Message msg) {
        ...
        if (tran.containsKey("DATE"))
            tran.put("date", formatPDateStrLong(tran.getString("DATE")));
        if (tran.containsKey("TIME"))
            tran.put("time", formatTimeStr(tran.getString("TIME")));
