...
public class Account {
    public JsonObject csv2json(String csv) {
        var split = csv.split("\\|");
    ...
    public String json2csv(JsonObject json) {
        ...
        account.append("|").append(json.getString("Phones")).append("|").append(json.getBoolean("AutoRenewRegister"));
        ...
        account.append("|").append(json.getString("AutoRenewRegCancelNotifyDate"));
