...
public class Deployer extends AbstractVerticle {
    ...
    public void start() throws Exception {
        ...
        mxCodecRegistry.addPackage("com.vx6.tools");
      /*mxCodecRegistry.register(new mxObjectCodec(new Website()) {
        ...
        //System.out.println("config: " + readConfig().encodePrettily());
        JsonArray verticleList = readConfig().getJsonArray("verticles");
    ...
    private JsonObject readConfig() throws FileNotFoundException {
        ...
        if (!configFile.isFile()) return new JsonObject();

        Scanner scanner = new Scanner(configFile).useDelimiter("\\A");
